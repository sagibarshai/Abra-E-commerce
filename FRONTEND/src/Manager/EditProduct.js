...
const TYPES_DATA = [ 
  {name:'Best_Sellers' , value:'Best_Sellers' , id:'Best_Sellers' , isChecked:false},
...
const formSubmitHandler = (e) => {
  ...
  axios.put(process.env.REACT_APP_BACKEND_URL + '/manager/edit-product', {
    formData
  })
  .then(res => {
...
<StyledCheckboxContainer>
  {typesData.map((type,index) => {
    ...
    return (
      ...
      <StyledCheckBox
      id={type.value} value={type.type} checked={type.isChecked} type="checkbox"
       onChange={() => {
